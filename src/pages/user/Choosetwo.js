...
class Choosetwo extends React.Component {
    ...
    gethead=()=>{
        return (
            ...
            return (
                <div key={item.img_id} className='choosedetail' onClick={()=>{this.props.history.push({ pathname: '/change', query: { headimg: item.headimg_url,title:'修改信息' } })}}>
...
export default withRouter(Choosetwo)